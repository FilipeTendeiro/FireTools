        ...
        for video_file in video_files:
            ...
            try:
                ...
                if result.returncode == 0 and os.path.exists(web_mp4_file):
                    ...
                    print(f"[WARNING] GPU encoding failed. Return code: {result.returncode}")
                    print(f"[WARNING] FFmpeg STDOUT: {result.stdout}")
                    print(f"[WARNING] FFmpeg STDERR: {result.stderr}")
